...
@Component({
  selector: 'app-d1lr',
  templateUrl: './d1lr.component.html',
  styleUrls: ['./d1lr.component.scss']
})
export class D1lrComponent implements OnInit {
  public xmlItems: any;
  ...
  async loadXML() {  
    await this._http.get(`https://www.basketplan.ch/showTeamSchedule.do?lang=de&xmlView=rss&seasonId=${this.icsService.seasonid}&teamId=6501`,
      {  
  ...
  download() {
    ...
    this.icsService.download("d1lr.ics", content);
  }
}
