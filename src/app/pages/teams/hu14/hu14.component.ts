...
@Component({
  selector: 'app-hu14',
  templateUrl: './hu14.component.html',
  styleUrls: ['./hu14.component.scss']
})
export class Hu14Component implements OnInit {
  public xmlItems: any;
  ...
  async loadXML() {  
    await this._http.get(`https://www.basketplan.ch/showTeamSchedule.do?lang=de&xmlView=rss&seasonId=${this.icsService.seasonid}&teamId=1051`,
      {  
  ...
  download() {
    ...
    this.icsService.download("hu14.ics", content);
  }
}
