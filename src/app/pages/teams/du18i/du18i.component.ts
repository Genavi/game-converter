...
@Component({
  selector: 'app-du18i',
  templateUrl: './du18i.component.html',
  styleUrls: ['./du18i.component.scss']
})
export class Du18iComponent implements OnInit {
  public xmlItems: any;
  ...
  async loadXML() {  
    await this._http.get(`https://www.basketplan.ch/showTeamSchedule.do?lang=de&xmlView=rss&seasonId=${this.icsService.seasonid}&teamId=1049`,
      {  
  ...
  download() {
    ...
    this.icsService.download("du18i.ics", content);
  }
}
