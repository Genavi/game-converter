...
@Component({
  selector: 'app-h3ls',
  templateUrl: './h3ls.component.html',
  styleUrls: ['./h3ls.component.scss']
})
export class H3lsComponent implements OnInit {
  public xmlItems: any;
  ...
  async loadXML() {  
    await this._http.get(`https://www.basketplan.ch/showTeamSchedule.do?lang=de&xmlView=rss&seasonId=${this.icsService.seasonid}&teamId=860`,
      {  
  ...
  download() {
    ...
    this.icsService.download("h3ls.ics", content);
  }
}
